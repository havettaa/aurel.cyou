  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        ...
        <p>
        A library for cryptocurrency trading with support for many bitcoin/ether/altcoin exchange markets.
        </p>
      </div>
      <div class="">
        ...
        <p class="mb-4">
          <a href="grid" class="text-gray-600">Grid</a>
        </p>
        <p class="mb-4">
          <a href="vue" class="text-gray-600">Vue</a>
        </p>
      </div>
      <div class="">
        <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
